...
@section('content')
                ...
                <tbody class="border-0">
                    @foreach ($applications as $application)
                        <tr data-application-id="{{ $application['id'] }}">
                            ...
                            <td>
                                <a href="#" class="text-decoration-none" data-application-id="{{ $application->id }}">{{ $application['approved'] ? 'Approved' : 'Not Approved' }}</a>
                            </td>
                            <td>
                                <div>
                                    ...
                                    @if (request()->get('status') == 'pending')
                                        <button class="approve-application-button btn btn-primary btn-sm {{ $application->date_paid ? '' : 'disabled' }}" data-bs-toggle="modal" data-bs-target="#confirm-approval-modal" data-application-id="{{ $application->id }}" data-has-tooltip="true" data-bs-placement="top" title="Approve" {{ $application->date_paid ? '' : 'disabled' }}>
                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-check-lg" viewBox="0 0 16 16">
                                                <path d="M12.736 3.97a.733.733 0 0 1 1.047 0c.286.289.29.756.01 1.05L7.88 12.01a.733.733 0 0 1-1.065.02L3.217 8.384a.757.757 0 0 1 0-1.06.733.733 0 0 1 1.047 0l3.052 3.093 5.4-6.425a.247.247 0 0 1 .02-.022Z" />
                                            </svg>
                                        </button>
                                        <button class="reject-application-button btn btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#reject-application-modal" data-application-id="{{ $application->id }}" data-has-tooltip="true" data-bs-placement="top" title="Reject">
    ...
    <div class="modal fade" id="view-application-modal" tabindex="-1" aria-hidden="true">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div id="application-details-wrapper" class="d-grid gap-3">
                        ...
                        <div>
                            <h4 class="mb-3">Application information</h2>
                                <div class="d-flex">
                                    <div class="row gap-3">
    ...
    {{-- rejection modal --}}
    <div class="modal fade" id="reject-application-modal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                    <button type="button" class="confirm btn btn-primary">Send message</button>
                </div>
            </div>
        </div>
    </div>
...
@section('script')
    ...
    <script>
        ...
        $(function() {
            ...
            $(approveApplicationModalElem).find('button.confirm').on('click', function() {
                let applicationId = $(this).attr('data-application-id')
