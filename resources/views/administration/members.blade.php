...
@section('content')
    ...
    <div id="content">
        ...
        <div class="table-wrapper">
            ...
            @else
                <div class="empty">
                    <svg xmlns="http://www.w3.org/2000/svg" width="168" height="168" preserveAspectRatio="xMidYMid meet" viewBox="0 0 24 24">
                        <path fill="gray" fill-opacity="0" d="M17 14V17a3 3 0 0 1-3 3H8a3 3 0 0 1-3-3V14z">
                        ...
                        <rect width="24" height="0" y="7" fill="gray" mask="url(#svgIDa)">
                    ...
                    <span>Seems like there nothing in here...</span>
                </div>
            @endif
